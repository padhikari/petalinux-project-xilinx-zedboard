...
HD_PWD='/proj/petalinux/2019.1/petalinux-v2019.1_0522_1/logs/bsps/avnet-digilent-zedboard-2019.1/hw_proj/avnet-digilent-zedboard-2019.1/avnet-digilent-zedboard-2019.1.runs/zed_rst_ps7_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_rst_ps7_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zed_rst_ps7_1_100M_0.tcl

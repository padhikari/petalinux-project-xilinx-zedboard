...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_1_axi_periph_M00_AXI [get_bd_intf_pins btns_5bits/S_AXI] [get_bd_intf_pins ps7_1_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_1_axi_periph_M01_AXI [get_bd_intf_pins leds_8bits/S_AXI] [get_bd_intf_pins ps7_1_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_1_axi_periph_M02_AXI [get_bd_intf_pins ps7_1_axi_periph/M02_AXI] [get_bd_intf_pins sws_8bits/S_AXI]
  connect_bd_intf_net -intf_net sws_8bits_GPIO [get_bd_intf_ports sws_8bits] [get_bd_intf_pins sws_8bits/GPIO]

  # Create port connections
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_pins btns_5bits/s_axi_aclk] [get_bd_pins leds_8bits/s_axi_aclk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins ps7_1_axi_periph/ACLK] [get_bd_pins ps7_1_axi_periph/M00_ACLK] [get_bd_pins ps7_1_axi_periph/M01_ACLK] [get_bd_pins ps7_1_axi_periph/M02_ACLK] [get_bd_pins ps7_1_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_1_100M/slowest_sync_clk] [get_bd_pins sws_8bits/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_1_100M_peripheral_aresetn [get_bd_pins btns_5bits/s_axi_aresetn] [get_bd_pins leds_8bits/s_axi_aresetn] [get_bd_pins ps7_1_axi_periph/ARESETN] [get_bd_pins ps7_1_axi_periph/M00_ARESETN] [get_bd_pins ps7_1_axi_periph/M01_ARESETN] [get_bd_pins ps7_1_axi_periph/M02_ARESETN] [get_bd_pins ps7_1_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_1_100M/peripheral_aresetn] [get_bd_pins sws_8bits/s_axi_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports USB_PULLUP] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs btns_5bits/S_AXI/Reg] SEG_btns_5bits_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs leds_8bits/S_AXI/Reg] SEG_leds_8bits_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs sws_8bits/S_AXI/Reg] SEG_sws_8bits_Reg
